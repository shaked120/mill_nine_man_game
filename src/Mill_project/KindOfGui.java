...
public class KindOfGui {
    private static final KindOfGui KIND_OF_GUI = new KindOfGui();
    private KindOfGui(){}

    public static KindOfGui getInstance(){
        return KIND_OF_GUI;
    }
    ...
    public void UpdateBoard(){
        ...
        System.out.println("|     |     "+ b.getHouses().get(6).getId() + b.getHouses().get(6).getMan().getToken()+" --- "
                + b.getHouses().get(7).getId() + b.getHouses().get(7).getMan().getToken()+" --- "+
                b.getHouses().get(8).getId() + b.getHouses().get(8).getMan().getToken()
                +"    |     |");
        System.out.println("|     |     |             |     |     |");
