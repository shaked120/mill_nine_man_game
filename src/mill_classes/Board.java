...
public class Board {
    ...
    private Board(){
        ...
        otherPlayer = new AlphaBetaAlgo(this, 10, 10, Color.Black);
...
// make jump for an insert player
    ...
    private void addPossibleMillTakes(SortedSet<ValuedJump> sortedJumps,
                                      AbstractJump jump, JumpEvaluationFunctionInterface evaluationFunction) {
    ...
    //number of soldiers out for each player
    public int getUnputPiecesOfCurrentPlayer() {
        return NUMBER_OF_STARTING_PIECES - placedPiecesCounters.get(currentPlayer.getColor());
    }
// check for valid jumps for the algo
    public List<AbstractJump> getValidJumps(JumpEvaluationFunctionInterface evaluationFunction) {
